...
import msu.ivan.rain.level.tile.spawn_level.SpawnFloorTile;
import msu.ivan.rain.level.tile.spawn_level.SpawnGrassTile;
import msu.ivan.rain.level.tile.spawn_level.SpawnHedgeTile;
import msu.ivan.rain.level.tile.spawn_level.SpawnWallTile;
import msu.ivan.rain.level.tile.spawn_level.SpawnWaterTile;

// create the Tiles
// one Tiles is simply the one Sprite with specific set of pixels
// that why, we create the Constructor with Sprite object
public class Tile {
	public int x, y;
